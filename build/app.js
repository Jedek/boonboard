...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chat = _interopRequire(__webpack_require__(1));
	...
	socket.on("initialized", function (constants) {
	    ...
	    render(React.createElement(Chat, { events: events }), document.getElementById("chats"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatScroller = _interopRequire(__webpack_require__(4));

	var ChatBox = _interopRequire(__webpack_require__(3));
	...
	var Chat = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(ChatScroller, null),
	            React.createElement(ChatBox, { events: this.props.events })
	        );
	    }
	});
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement("input", { id: "input-chat", type: "text", placeholder: "Type a message here...", className: "form-control" }),
	                React.createElement(
	                    "span",
	                    { id: "btn-chat", className: "input-group-btn" },
	                    React.createElement(
	                        "button",
	                        { type: "button", onClick: this.sendChat, className: "btn btn-green" },
	                        React.createElement(
	                            "i",
	                            { "class": "fa fa-check" },
	                            "Send!"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatScroller = React.createClass({
	    displayName: "ChatScroller",
	    render: function () {
	        return React.createElement(
	            "div",
	            { className: "chat-scroller" },
	            React.createElement("ul", { className: "chats", id: "the_chat" })
	        );
	    }
	});
